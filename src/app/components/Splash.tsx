      ...
      <div className="flex flex-col items-center justify-center gap-8 w-full px-12 lg:px-0">
        ...
        <div className="w-full flex flex-col justify-center">
          <div className="flex flex-wrap items-center justify-between gap-3 mb-4">
            ...
            <span className="inline-flex items-center px-3 py-1 backdrop-blur-md bg-blue-100/70 border border-blue-200/60 text-blue-900 rounded-full text-xs font-medium tracking-wide shadow-sm">
              SWE @ Gemini · NYC
            </span>
          </div>
          ...
          {/* Interests */}
          <div className="w-full flex flex-wrap gap-2.5 text-xs text-gray-600">
            {[
